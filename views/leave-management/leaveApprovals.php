                ...
                <?php
                 if($row['status'] == 'approved')
                 {
                   ...
                   <span class="badge badge-success"  style="cursor: pointer;" title="Leave is Approved"
                         onclick="ChangeStatuss('<?php echo $row['id'];?>','pending_approval');">approved</span>
                   <?php
                 }
                 else
                 {
                   ...
                   <span class="badge badge-danger"  style="cursor: pointer;"  title="Leave Pending Approval"
                         onclick="ChangeStatuss('<?php echo $row['id'];?>','approved');">Pending Approval</span>
                   <?php
                 }
                    ...
                    <form id="add-leave-details-form">
                      ...
                      <div class="row border-bottom mx-3">
                         ...
                         <div class="col-lg-4 col-xs-12 form-group">
                             ...
                             <?php
                             $result = mysqli_query($dbc, "SELECT * FROM leave_type ORDER BY id ASC");
                             echo '
                             <select name="leave_name" data-tags="true" class="select2 form-control" data-placeholder="Select Leave type" required>
                             <option></option>';
...
<?php
     ...
     <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page">Training Mangement for company <b><?php echo $_SESSION['fName']; ?>  </b></li>
          </ol>
     </nav>
