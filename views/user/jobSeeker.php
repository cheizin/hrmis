...
<nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active" aria-current="page">
            <i class="far fa-user-plus"></i> <b>Welcome <?php echo $_SESSION['fName']; ?></b>
            ...
            $sql_query1 =  mysqli_query($dbc,"SELECT * FROM application_status_details WHERE email ='".$_SESSION['email']."' && status_name = 'Testing'  ORDER BY id");
            $number = 1;
            if($total_rows1 = mysqli_num_rows($sql_query1) > 0)
            {?>

           <i class="fa fa-pen" style="font-size:15px;color:blue" onclick="applyTest('<?php echo $test_details['reference_no'];?>');" title="Click here to do the Test">
                 <span class="text-primary" style="cursor:pointer;">Click Here to do the Test</span>
           </i>
...
<?php
$no = 1;
$sql2= mysqli_query($dbc,"SELECT * FROM awards WHERE email ='".$_SESSION['email']."' ORDER BY year_received DESC ");
