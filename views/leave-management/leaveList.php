...
if($_SESSION['access_level'] == 'admin')
{
         ...
         <div class="card card-success card-outline">
           <div class="card-header">
            Leave List
             ...
             <button class="btn btn-link" style="float:right;"
                     data-toggle="modal" data-target="#add-leave-modal">
           ...
           <div class="card-body table-responsive">
            ...
            <table class="table table-striped table-bordered table-hover" id="invoice-received-table" style="width:100%">
              ...
              <?php
              $no = 1;
               $sql = mysqli_query($dbc,"SELECT * FROM leave_details ORDER BY id DESC");
                ...
                <?php
                 if($row['status'] == 'approved')
                 {
                   ...
                   <span class="badge badge-success"  style="cursor: pointer;" title="Leave is Approved"
                         onclick="ChangeStatusss('<?php echo $row['id'];?>','deactivated');">approved</span>
                   <?php
                 }
                 else
                 {
                   ...
                   <span class="badge badge-danger"  style="cursor: pointer;"  title="Leave Pending Approval"
                         onclick="ChangeStatusss('<?php echo $row['id'];?>','active');">Pending Approval</span>
                   <?php
                 }
     ...
     <strong><i class="fa fa-info-circle"></i> No leave recorded</strong>
     </div>
     ...
     <!-- add sell module modal -->
          ...
          <div class="modal fade" id="add-leave-modal" role="dialog">

              <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                <div class="modal-content">
                  <div class="modal-header alert alert-success">

                    <h5 class="modal-title">Leave Application <b><?php echo $profile_pic['fName'];?> </b></h5>
                  ...
                  <div class="modal-body">
                    <form id="add-leave-details-form">

                      <input type="hidden" name="add-leave-details" value="add-leave-details">
                      <div class="row border-bottom mx-3">


                         <div class="col-lg-4 col-xs-12 form-group">
                             <label><span class="required">*</span>Leave Type</label>
                             <?php
                             $result = mysqli_query($dbc, "SELECT * FROM leave_type ORDER BY leave_name ASC");
                             echo '
                             <select name="leave_name" data-tags="true" class="select2 form-control" data-placeholder="Select Leave type"
                             id="leave_name" onChange="getDays();"  required>
                             <option></option>';
                         ...
                         <div class="col-lg-4 col-xs-12 form-group">
                             <label><span class="required">*</span>Reliever Name</label>
                             <?php
                             $result = mysqli_query($dbc, "SELECT * FROM staff_users ORDER BY id ASC");
                             echo '
                             <select name="reliever" data-tags="true" class="select2 form-control" data-placeholder="Select Reliever Name" required>
                             <option></option>';
                             while($row = mysqli_fetch_array($result)) {
                         ...
                         <div class="col-lg-4 col-xs-12 form-group">
                             <label><span class="required">*</span>Entitled Days</label>

                               <select name="entitled_days" id="ent_days" class="select form-control" CMA>
                       ...
                       <div class="row border-bottom mx-3">
                         ...
                         <div class="col-lg-4 col-xs-12 form-group">
                            ...
                            <div class="col-lg-12 col-xs-12 form-group">
                                <label for="item_name"><span class="required">*</span>Reason</label>
   ...
   if($_SESSION['access_level'] == 'trainee')
   {
        ?>
        <nav aria-label="breadcrumb">
             <ol class="breadcrumb">
               <li class="breadcrumb-item active" aria-current="page">Trainee Details for <b><?php echo $_SESSION['fName']; ?>  </b></li>
             </ol>
        </nav>
       ...
       $personal_details = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM staff_users WHERE fName ='".$_SESSION['fName']."'"));
               ...
               <table class="table table-striped table-bordered table-hover" id="invoice-received-table" style="width:100%">
                 ...
                 <tr style="cursor: pointer;">
                   ...
                   <td>  <?php echo $row['id'] ;?>
                              ...
                              <td onclick="viewTraineeList('<?php echo $row['id'];?>');" title="Click here to view More Details">
        ...
        <strong><i class="fa fa-info-circle"></i> No Trainee details recorded</strong>
        </div>
...
<?php
         ...
         if($_SESSION['access_level'] == 'trainer')
         {
              ?>
              <nav aria-label="breadcrumb">
                   <ol class="breadcrumb">
                     <li class="breadcrumb-item active" aria-current="page">Trainee Details  </b></li>
                   </ol>
              </nav>
             ...
             $personal_details = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM staff_users WHERE access_level = 'trainee'    "));
               ?>
      ...
      <?php
        ...
        if($_SESSION['access_level'] == 'TRAINING_MANAGEMENT')
        {

     ?>
     <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page">Training Management for company <b><?php echo $_SESSION['fName']; ?>  </b></li>
          </ol>
     </nav>
       ...
       <div class="col-lg-12 col-xs-12">
         <div class="card card-success card-outline">
           <div class="card-header">
             ...
             <button class="btn btn-link" style="float:right;"
                     data-toggle="modal" data-target="#add-leave-modal">
                     <i class="fa fa-plus-circle"></i> Add a Trainee
             </button>
           </div>
           <div class="card-body table-responsive">
...
<?php
 if($row['status'] == 'active')
 {
   ...
   <span class="badge badge-success"  style="cursor: pointer;" title="User Is Active. Click to Deactivate"
         onclick="ChangeTrainStatus('<?php echo $row['id'];?>','deactivated');">active</span>
   <?php
 }
 else
 {
   ...
   <span class="badge badge-danger"  style="cursor: pointer;"  title="User Is deactivated. Click to Activate"
         onclick="ChangeTrainStatus('<?php echo $row['id'];?>','active');">deactivated</span>
   <?php
 }
...
?>
     ...
     <!-- add job seeker modal -->
     <div class="modal fade" id="add-leave-modal">
     <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
       <div class="modal-content">
         <div class="modal-header alert alert-success">

           <h5 class="modal-title">Adding Personal Details for Trainees </h5>
           <button type="button" class="close" data-dismiss="modal" aria-label="Close">
             <span aria-hidden="true">&times;</span>
           </button>
         </div>
         <div class="modal-body">
           <form id="training-details-form" class="mt-4" enctype="multipart/form-data">
             <input type="hidden" value="add-trainee-details" name="add-trainee-details">
               <input type="hidden" value="trainee" name="trainee">
           ...
           <!-- start of row -->
               ...
               <div class="col-lg-3 col-xs-12 form-group">
                 ...
                 <div class="col-lg-3 col-xs-12 form-group">
                   ...
                   title="Your Password associated to your Windows account" ></i></label>
                   <div class="input-group add-on">
                   <input type="password" name="password" maxlength="40" class="form-control pwd password"  required placeholder="input your password">
                   ...
                   <i class="glyphicon glyphicon-info-sign password_help" data-toggle="tooltip" data-placement="right"
                   title="Your Password associated to your Windows account" ></i></label>
                   <div class="input-group add-on">
                   <input type="password"  name="confirm" maxlength="40" class="form-control pwd confirm"  required placeholder="Confirm Your password">
