  ...
  <div class="card card-success card-outline">
    <div class="card-header">
      ...
      <button class="btn btn-link" style="float:right;"
              data-toggle="modal" data-target="#add-dependants-details-modal">
    ...
    <div class="card-body table-responsive">
      ...
      <?php
   $sql_query1 =  mysqli_query($dbc,"SELECT * FROM dependants_details WHERE reference_no ='".$_POST['id']."' ORDER BY id DESC");
   ...
   {?>
     <table class="table table-striped table-bordered table-hover" id="end-product-table" style="width:100%">
       ...
       <?php
          $no = 1;
          $sql= mysqli_query($dbc,"SELECT * FROM dependants_details WHERE reference_no ='".$_POST['id']."' ORDER BY id DESC");
          while($product = mysqli_fetch_array($sql))
          {
            ...
            <tr style="cursor: pointer;">
              ...
              <td><?php echo $product['dependant_name'];?></td>
              <td><?php echo $product['relationship'];?></td>
...
<strong><i class="fa fa-info-circle"></i> No dependants Details Added</strong>
</div>
...
<div class="modal fade" id="add-dependants-details-modal" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header alert alert-success">

        <h5 class="modal-title">Deoendants details for <b><?php echo $profile_pic['fName'];?> </b></h5>
      ...
      <div class="modal-body">
        <form id="add-dependants-details-form">
          <input type="hidden" name="reference_no" value="<?php echo $_POST['id'];?>">

          <input type="hidden" name="add-dependants-details" value="add-dependants-details">
          <div class="row border-bottom mx-3">

              <div class="col-lg-12 col-xs-12 form-group">
                  <label for="item_name"><span class="required">*</span>Dependant Name</label>

                    <input type="text" autocomplete="off" class="select2 form-control" name="dependant_name">

              </div>
              <div class="col-lg-12 col-xs-12 form-group">
                  <label for="item_name"><span class="required">*</span>Relationship</label>

                    <input type="text" autocomplete="off" class="select2 form-control" name="relationship">

              </div>
              <div class="col-lg-12 col-xs-12 form-group">
                  <label for="item_name"><span class="required">*</span>Contact</label>
