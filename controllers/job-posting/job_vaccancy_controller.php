...
$sql_insert= mysqli_query($dbc,"INSERT INTO job_posting
      (email, job_title, com_type, expLength, emp_type, rank_name,exp_level, job_location, country, deadline, job_description,responsibility,date_recorded,time_recorded)
        VALUES ('".$email."','".$job_title."','".$com_type."', '".$expLength."', '".$emp_type."','".$rank_name."','".$exp_level."', '".$job_location."',
          '".$country."','".$deadline."', '".$job_description."','".$responsibility."','".$date_recorded."','".$time_recorded."')") or die (mysqli_error($dbc));
...
$sql_insert= mysqli_query($dbc,"INSERT INTO request_application
      (reference_no, post_name, special_info, time_recorded, recorded_by)
        VALUES ('".$id."','".$post_name."', '".$special_info."','".$time_recorded."',
          '".$recorded_by."')") or die (mysqli_error($dbc));

//log the action
$action_reference = "Requested Job APPLICATION FOR" . $email;
