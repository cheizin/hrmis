      ...
      <div class="avatar mx-auto white">
        ...
        <ul class="list-group list-group-unbordered mb-3">
          <li class="list-group-item">
            <b>Location:</b> <a class="float-right"><?php echo $profile_pic['location'] ;?></a>
          </li>
          <li class="list-group-item">
            <b>Contact:</b> <a class="float-right"><?php echo $profile_pic['contact'] ;?> </a>
          </li>
          <li class="list-group-item">
            <b>Access Level:</b> <a class="float-right"><?php echo $profile_pic['access_level'] ;?></a>
          </li>
          <li class="list-group-item">
            <b>Identifier No:</b> <a class="float-right"><?php echo $profile_pic['id'] ;?></a>
          </li>
        </ul>
