...
<nav aria-label="breadcrumb">
     <ol class="breadcrumb">
       <li class="breadcrumb-item active" aria-current="page">All Job posting with Applicants</li>
     </ol>
</nav>
...
<div class="modal fade" id="post-job-modal" onmouseenter="CallSmartWizard3()">
<div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
  ...
  <div class="modal-header alert alert-success">
    ...
    <div class="modal-body">
      <form id="add-job-vaccancy-form" class="needs-validation" enctype="multipart/form-data">
        <input type="hidden" value="post-job" name="post-job">
         <input type="hidden" name="email" value ="<?php echo $_SESSION['email'];?>" >


         <div id="smartwizard-add-job-vaccancy-form" style="height:400px;">
<ul class="nav">
<li>
