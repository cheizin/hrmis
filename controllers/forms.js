        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              ...
              Toast.fire({
                ...
                $('#add-job-seeker-modal').modal('hide');
...
// Update the button text
btn.textContent = 'Submitting Job title...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-seeker/job_seeker_controller.php';
    var form_method = 'POST';
...
//post job vaccancy
$(document).on("submit","#add-job-vaccancy-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Assigning Job Status Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-posting/job_vaccancy_controller.php';
    var form_method = 'POST';
...
function CloseProject(id) {
  ...
  Swal.fire({
      title: 'This Project will be removed from the active projects list',
      text: "Are you sure to proceed?",
      icon: 'question',
      showCancelButton: true,
