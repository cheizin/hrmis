...
<div class="col-lg-3 col-xs-8 form-group">
No Of Employees: <input type="text" class="form-control" name="start_ts" value="<?php echo $profile_pic['emp_no'];?>" readonly="readonly">

</div>

<div class="col-lg-3 col-xs-8 form-group">
Web url: <input type="text" class="form-control" name="start_ts" value="<?php echo $profile_pic['web_url'];?>" readonly="readonly">
...
<i class="fa fa-plus-circle"></i> Add More Information Abou the company
</button>
