<?php
  ...
  $jobs_sql = mysqli_query($dbc,"SELECT * FROM job_posting WHERE email ='".$_SESSION['email']."' ");
...
<nav aria-label="breadcrumb">
     <ol class="breadcrumb">
       <li class="breadcrumb-item active" aria-current="page">Recruiter Dashboard </li>
     </ol>
</nav>
    ...
    <div class="row">
      <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box" title="Total Stocks Available">
          ...
          <div class="info-box-content hvr-overline-from-center">
            <span class="info-box-text">  <strong><?php echo $total_jobs;?></strong> Jobs Posted</span>
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box" title="Total End Product Deliveries">
          ...
          <div class="info-box-content hvr-overline-from-center">
            <span class="info-box-text">  <strong><?php echo $total_end_product;?></strong> Responsed Test</span>
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3" title="Projects Payments for Active Projects">
          ...
          <div class="info-box-content hvr-overline-from-center">
            <span class="info-box-text">  <strong><?php echo $total_invoices_received ;?></strong> Sent Requests</span>
