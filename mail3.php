...
session_start();
 ...
 $mail = new phpmailer;
  ...
  //  $mail->SMTPAuth   = true;                                   // Enable SMTP authentication
    ...
    //Recipients
  $mail->setFrom('autoreply@wisegeneration.co.ke', 'HRMIS System');
    $mail->addAddress('gathonig778@gmail.com', 'HRMIS System');     // Add a recipient
       $mail->addCC('pchege@students.uonbi.ac.ke');
   // $mail->addBCC('pcheizin@gmail.com');
...
autoreply@wisegeneration.co.kw On Potential staffing sdafasfas grfdg the login page Click on forgot password<br/><br/> Use the following Link for Login
