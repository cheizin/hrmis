...
function LoadDatatables()
{
  $('#user-profile-sign-in-logs-table').DataTable({
    ...
    $('#risks-management-table').DataTable({
      ...
      var table = $('.invoice-received-table234').DataTable({
        destroy:true
      });
...
//var unit_price = $('.stock_unit_price2').val();
var allocated_amt = $('.allocated_amt').val();
  var budget_amount = $('.budget_amount').val();

//var total = unit_price * qtt;
var new_budget_amount = budget_amount - allocated_amt;
...
*/
  ...
  //$('.stock_total2').val(total.toFixed(2));
  $('.new_budget_amount').val(new_budget_amount.toFixed(0));
