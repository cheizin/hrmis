...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
 ...
 if(isset($_POST['add-trainee-details']))
{
  $cName = mysqli_real_escape_string($dbc,strip_tags($_POST['company_name']));
  $access_level = mysqli_real_escape_string($dbc,strip_tags($_POST['trainee']));
...
//log the action
$action_reference = "Added Trainee " . $fName;
$action_name = "Trainee Information Creation";
...
else if(isset($_POST['add-trainer-details']))
{
 $cName = mysqli_real_escape_string($dbc,strip_tags($_POST['company_name']));
 $access_level = mysqli_real_escape_string($dbc,strip_tags($_POST['trainer']));
 $fName = mysqli_real_escape_string($dbc,strip_tags($_POST['fName']));
 $lName = mysqli_real_escape_string($dbc,strip_tags($_POST['lName']));
 $dob = mysqli_real_escape_string($dbc,strip_tags($_POST['dob']));
 $gender = mysqli_real_escape_string($dbc,strip_tags($_POST['gender']));
...
else if(isset($_POST['add_quiz_answer']))
{
  $id = mysqli_real_escape_string($dbc,strip_tags($_POST['eid']));
...
$sql_insert= mysqli_query($dbc,"INSERT INTO answered_test2
    (reference_no, email, answer_name, time_recorded)
      VALUES ('".$id."','".$email."','".$answer_name."', '".$time_recorded."')")
       or die (mysqli_error($dbc));

//log the action
$action_reference = "Answered the Quiz " . $answer_name;
...
//log the action
$action_reference = "Response for the QUIZ " . $response_name;
$action_name = "Answered Test";
$action_icon = "far fa-project-diagram text-success";
$page_id = "Job Application Details";
$time_recorded = date('Y/m/d H:i:s');
...
else if(isset($_POST['add-course-trainers']))
{
...
$sql_insert= mysqli_query($dbc,"INSERT INTO course_student
     (subject, student_name,date_recorded,time_recorded)
       VALUES ('".$subject."','".$fName."','".$date_recorded."',  '".$time_recorded."')") or die (mysqli_error($dbc));


//log the action
$action_reference = "Assigned course to a trainee" . $fName;
$action_name = "Course assignment Information Creation";
$action_icon = "far fa-project-diagram text-success";
$page_id = "Course assignment Application Details";
$time_recorded = date('Y/m/d H:i:s');
...
else if(isset($_POST['add-job-post2']))
{

      mysqli_autocommit($dbc, FALSE);

  $id = mysqli_real_escape_string($dbc,strip_tags($_POST['eid']));
  $job_title  = mysqli_real_escape_string($dbc,strip_tags($_POST['subject']));
...
$sql_insert= mysqli_query($dbc,"INSERT INTO assigned_test
      (reference_no, posted_job, time_recorded, recorded_by)
        VALUES ('".$eid."','".$job_title."','".$time_recorded."',
          '".$recorded_by."')") or die (mysqli_error($dbc));

//log the action
$action_reference = "Assigned Course to " . $job_title;
$action_name = "Quiz Assignment";
$action_icon = "far fa-project-diagram text-success";
...
exit("failed");
  ...
  else if(isset($_POST['add_quiz_history']))
  {
  ...
  //log the action
  $action_reference = "Added a quiz with details" . $test_name;
  $action_name = "quiz APPLICATION request";
  $action_icon = "far fa-project-diagram text-success";
  $page_id = "About Me personal Details";
  $time_recorded = date('Y/m/d H:i:s');
...
else if(isset($_POST['add-whole-budget']))
{

 $subject= mysqli_real_escape_string($dbc,strip_tags($_POST['subject']));
  $budget_amount = mysqli_real_escape_string($dbc,strip_tags($_POST['budget_amount']));
...
$sql_insert= mysqli_query($dbc,"INSERT INTO whole_budget
     (subject, budget_amount,date_recorded,time_recorded)
       VALUES ('".$subject."','".$budget_amount."','".$date_recorded."',  '".$time_recorded."')") or die (mysqli_error($dbc));


//log the action
$action_reference = "Added budget amount for" . $subject;
$action_name = "Budget Information Creation";
$action_icon = "far fa-project-diagram text-success";
$page_id = "Course assignment Application Details";
$time_recorded = date('Y/m/d H:i:s');
...
else if(isset($_POST['budget-list']))
{
  $subject= mysqli_real_escape_string($dbc,strip_tags($_POST['subject']));
   $allocated_amount = mysqli_real_escape_string($dbc,strip_tags($_POST['allocated_amount']));
   $budget_amount = mysqli_real_escape_string($dbc,strip_tags($_POST['budget_amount']));
   $remaining_amount= mysqli_real_escape_string($dbc,strip_tags($_POST['remaining_amount']));
    $trainee_name = mysqli_real_escape_string($dbc,strip_tags($_POST['trainee_name']));
...
$sql_insert= mysqli_query($dbc,"INSERT INTO individual_budget
     (subject, trainee_name, budget_amount, allocated_amount, remaining_amount, date_recorded, time_recorded)
       VALUES ('".$subject."','".$trainee_name."','".$budget_amount."','".$allocated_amount."','".$remaining_amount."', '".$date_recorded."', '".$time_recorded."')")
       or die (mysqli_error($dbc));


//log the action
$action_reference = "Added Budget for traineet" . $trainee_name;
$action_name = "Trainee Budget Information Creation";
$action_icon = "far fa-project-diagram text-success";
$page_id = "Job Seeker Application Details";
$time_recorded = date('Y/m/d H:i:s');
...
else if(isset($_POST['add-course-materials']))
{


  $course_name = mysqli_real_escape_string($dbc,strip_tags($_POST['course_name']));
...
//  $product_name = mysqli_real_escape_string($dbc,strip_tags($_POST['product_name']));
  ...
  $uploadDir = '../../views/training-management/documents/';
  $uploadStatus = 1;
  $uploadedFile = '';
  ...
  if(!empty($_FILES["file"]["name"])){
    ...
    $insert_documents = mysqli_query($dbc,"INSERT INTO course_materials
      (reference_no, course_name, material_name, recorded_by)
    VALUES ('".$reference_no."','".$course_name."', '".$additional_file2."','".$recorded_by."')") or die (mysqli_error($dbc));



  //log the action
  $action_reference = "Attached E-MATERIALS for the reference " . $reference_no;
...
else if(isset($_POST['deactivate_course']))
{
  /* set autocommit to off */
  mysqli_autocommit($dbc, FALSE);
  ...
  $change_status = mysqli_query($dbc,"UPDATE training_course_details SET status='$status' WHERE id='".$id."'");

  //log the action
  $action_reference = "Changed the status of the course with id " . $id. " to ".$status;
  $action_name = "Course Status Change";
...
else if(isset($_POST['add-course-details']))
{
  $reference_no = mysqli_real_escape_string($dbc,strip_tags($_POST['reference_no']));
...
$start_date = mysqli_real_escape_string($dbc,strip_tags($_POST['product_start_date']));
$end_date = mysqli_real_escape_string($dbc,strip_tags($_POST['product_end_date']));
...
$sql_insert= mysqli_query($dbc,"INSERT INTO training_course_details
    (reference_no, institution, course_name, description,start_date, end_date, duration, date_recorded, time_recorded)
      VALUES ('".$reference_no."','".$institution."','".$course_name."', '".$description."','".$start_date."', '".$end_date."',
         '".$duration."', '".$date_recorded."', '".$time_recorded."')") or die (mysqli_error($dbc));

//log the action
$action_reference = "Added Course Details" . $bank_name;
$action_name = "Course Information Creation";
$action_icon = "far fa-project-diagram text-success";
$page_id = "Job Seeker Application Details";
$time_recorded = date('Y/m/d H:i:s');
