...
if($_SESSION['access_level'] == 'admin')
{
     ...
     <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page">Training Mangement</li>
          </ol>
     </nav>
       ...
       <div class="col-lg-12 col-xs-12">
         <div class="card card-success card-outline">
           <div class="card-header">
            Trainee List
             ...
             <button class="btn btn-link" style="float:right;"
                     data-toggle="modal" data-target="#add-trainee-modal">
           ...
           <div class="card-body table-responsive">
             ...
             <?php
             $sql_query1 =  mysqli_query($dbc,"SELECT * FROM staff_users WHERE access_level = 'trainee' || access_level = 'trainer'  || access_level = 'TRAINING_MANAGEMENT'   ORDER BY id ");
            ...
            <table class="table table-striped table-bordered table-hover" id="invoice-received-table" style="width:100%">
              ...
              <?php
              $no = 1;
               $sql = mysqli_query($dbc,"SELECT * FROM staff_users WHERE access_level = 'trainee' || access_level = 'trainer'  || access_level = 'TRAINING_MANAGEMENT'   ORDER BY id DESC");
     ...
     <!-- add sell module modal -->
          ...
          <div class="modal fade" id="add-trainee-modal">
